  ...
  return (
    <div className="flex flex-col space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-semibold tracking-tight text-primary-text">Drivers & Safety Profiles</h1>
        <button
      ...
      <div className="flex items-center space-x-4 mt-6 border-t border-border pt-6">
        <span className="text-xs font-semibold text-secondary-text uppercase tracking-wider">Toggle Stat</span>
